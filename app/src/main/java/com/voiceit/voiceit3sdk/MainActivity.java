...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		myVoiceIt = new VoiceItAPI3("API_KEY HERE","API_TOKEN HERE");
        ...
        try {
            if (response.getString("responseCode").equals("IFVD")
                ...
                Toast.makeText(this, "responseCode: " + response.getString("responseCode")
                         + ", " + getString(com.voiceit.voiceit3.R.string.CHECK_CODE), Toast.LENGTH_LONG).show();
                Log.e("MainActivity","responseCode: " + response.getString("responseCode")
                        + ", " + getString(com.voiceit.voiceit3.R.string.CHECK_CODE));
            }
        } catch (JSONException e) {
